...
<ul>
  <li class="explode" key="02_cat_and_goods" name="menu">
    商品管理        <ul>
          ...
          <li class="menu-item"><a href="<?php echo U('Admin/Goods/add')?>" target="main-frame">添加新商品</a></li>

          <li class="menu-item"><a href="<?php echo U('Category/lst')?>" target="main-frame">商品栏目</a></li>
