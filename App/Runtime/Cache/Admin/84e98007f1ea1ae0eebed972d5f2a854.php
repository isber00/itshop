...
<div class="main-div">
  <form action="/admin.php/Admin/Attribute/add" method="post" name="theForm" enctype="multipart/form-data">
  <table width="100%" id="general-table">
      ...
      <tr>
        ...
        <td>
               ...
               <input type="radio" name="attr_input_type" value="1"/>从下面的列表选择（多个用逗号隔开）
        </td>
      </tr>
      <tr>
        <td class="label">可选值列表:</td>
        <td>
               <textarea name="attr_value" rows="4" cols="50"> </textarea>
        </td>
      </tr>
      <tr>
        <td class="label"></td>
