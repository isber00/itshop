...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body style="cursor: auto;">
        ...
        <div class="block box">
            <div class="blank"></div>
            <div id="ur_here">
                当前位置: <a href="<?php echo C('WEB_URL')?>">首页</a> 
                <?php foreach($catenvdata as $v){?>
                <code>&gt;</code> <a href="<?php echo U('Home/Index/category',array('id'=>$v['id']))?>"><?php echo $v['cat_name']?></a> 
                <?php }?>
        ...
        <div class="block clearfix">
            ...
            <div class="AreaR">
                <div id="goodsInfo" class="clearfix">
                    <div class="imgInfo">
                        <a style="position: relative; display: block; outline: 0pt none; text-decoration: none; width: 310px; -moz-user-select: none;" href="/Public/Uploads/<?php echo $goods_info['goods_img']?>" id="zoom1" class="MagicZoom MagicThumb" title="诺基亚E66">
                            <img id="sim806035" src="/Public/Uploads/<?php echo $goods_info['goods_img']?>" alt="诺基亚E66" height="310px" width="310px;" />
                        ...
                        <div class="picture" id="imglist">
                            <a style="outline: 0pt none;" href="./images/200905/goods_img/9_P_1241511871575.jpg" rel="zoom1" rev="images/200905/goods_img/9_P_1241511871575.jpg" title="">
                                <img src="/Public/home/images/9_thumb_P_1241511871787.jpg" alt="诺基亚E66" class="onbg" /></a>
                        </div>
                    </div>

                    <div class="textInfo">
                        <form action="<?php echo U('Home/Cart/addCart')?>" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY">
                            ...
                            <ul>
                                ...
                                <li class="padd loop">
                                    ...
                                    <label for="spec_value_227">
                                        <input name="goods_attr_<?php echo $k;?>" value="<?php echo $v1['id']?>" id="spec_value_227" <?php if($k1==0){echo 'checked="checked"';}?> onclick="changePrice()" type="radio" />
                                        <?php echo $v1['attr_value']?> </label>
                                    <?php }?>
                                </li>
                                <?php }?>
                                <li class="padd">
                                    <a href="javascript:" onclick="addCart()"><img src="/Public/home/images/goumai2.gif"></a>
