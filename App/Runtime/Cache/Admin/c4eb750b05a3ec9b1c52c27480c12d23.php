...
function charea(a) {
    var spans = ['general','detail','mix','attr'];
    for(i=0;i<4;i++) {
...
$(function(){
    $("select[name=type_id]").change(function(){
        ...
        //使用ajax传递type_id根据type_id取出属性的内容（属性内容也是返回的html代码）
        $.ajax({
            type:'get',
            url:'/admin.php/Admin/Goods/showattr/type_id/'+type_id,
...
<div class="tab-div">
    ...
    <!-- tab body -->
    <div id="tabbody-div">
      <form enctype="multipart/form-data" action="/admin.php/Admin/Goods/add.html" method="post" name="theForm" >
        <!-- 最大文件限制 -->
