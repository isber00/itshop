...
<h1>
<span class="action-span"><a href="/admin.php/Admin/Type/add">添加商品类型</a></span>
...
<table width="100%" cellspacing="1" cellpadding="2" id="list-table">
  ...
  <?php foreach($typedata as $v){?>
    ...
    <td align="left" class="first-cell" style = 'padding-left="0"'>
            ...
            <span><a href="#" ><?php echo $v['type_name']?></a></span>
        </td>
    <td width="10%" align="right"><span><?php echo $v['attr_count']?></span></td>
    <td width="24%" align="center">
      <a href="<?php echo U('Admin/Attribute/lst',array('type_id'=>$v['id']))?>">属性列表</a> |
      <a href="#">编辑</a> |
