...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div class="block box">
            <div class="blank"></div>
            <div id="ur_here">
                当前位置: <a href="#">首页</a> <code>&gt;</code><a href="<?php echo U('Home/Index/index');?>"> 购物流程 </a>
            </div>
        </div>
        ...
        <div class="block">
            <form action="/index.php/Home/Order/done" method="post" name="theForm" id="theForm" >
                <div class="flowBox">
                    ...
                    <table cellpadding="5" cellspacing="1" width="99%">
                        ...
                        <?php foreach($cartdata as $v){?>
                            <tr>
                                ...
                                <td align="right">￥<?php echo $v['info']['shop_price']*$v['goods_number'];?>元</td>
                            </tr>
                        <?php }?>
                            
                            <tr>
                                <td colspan="7">
                                    购物金额小计 ￥<?php echo $total['total_price']?>元，比市场价 ￥6012.00元 节省了 ￥1002.00元 (17%)              </td>
                            </tr>
                        </tbody></table>
                </div>
                <div class="blank"></div>
                ...
                <div class="flowBox">
                    ...
                    <table id="shippingTable" cellpadding="5" cellspacing="1" width="99%">
                        <tbody><tr>
                            ...
                            <tr>
                                <td valign="top"><input name="shipping" value="申通快递"  type="radio" />
                                </td>
                            ...
                            <tr>
                                <td valign="top"><input name="shipping" value="城际快递"  type="radio" />
                                </td>
                            ...
                            <tr>
                                <td valign="top"><input name="shipping" value="邮局平邮"   type="radio" />
                                </td>
                ...
                <div class="flowBox">
                    ...
                    <table id="paymentTable" cellpadding="5" cellspacing="1" width="99%">
                        <tbody><tr>
                            ...
                            <tr>
                                <td valign="top"><input name="payment" value="余额支付" iscod="0" type="radio" /></td>
                            ...
                            <tr>
                                <td valign="top"><input name="payment" value="银行汇款/转帐" iscod="0" type="radio" /></td>
                            ...
                            <tr>
                                <td valign="top"><input name="payment" value="货到付款" iscod="1" disabled="true" type="radio" /></td>
