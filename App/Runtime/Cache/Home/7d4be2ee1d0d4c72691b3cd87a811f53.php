        ...
        <div class="block clearfix">
            <div class="AreaL">
                ...
                <?php foreach($catedata as $v){ if($v['parent_id']==0){ ?>
                    <dl>
                        <dt><a href="<?php echo U('Home/Index/category',array('id'=>$v['id']))?>"><?php echo $v['cat_name']?></a></dt>
                        <dd> 
                            <?php  foreach($catedata as $v1){ if($v1['parent_id']==$v['id']){ ?>
                            <a href="<?php echo U('Home/Index/category',array('id'=>$v1['id']))?>"><?php echo $v1['cat_name']?></a>
                            <?php }}?>
                        </dd>
                    </dl>
                  <?php  }}?>  
                    ...
                    <div class="box_1">
                        ...
                        <form name="compareForm" action="compare.php" method="post" onsubmit="return compareGoods(this);">
                            ...
                            <?php foreach($goodsdata as $v){?>
                                <div class="goodsItem">
                                    <a href="<?php echo U('Home/Index/detail',array('id'=>$v['id']))?>"><img src="<?php echo trim(C('UPLOAD_ROOT_PATH').$v['goods_thumb'],'.');?>" alt="诺基亚N85" class="goodsimg"></a><br />
                                    <p><a href="<?php echo U('Home/Index/detail',array('id'=>$v['id']))?>" title="诺基亚N85"><?php echo $v['goods_name']?></a></p>
