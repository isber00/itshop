        ...
        <div class="block clearfix">
            ...
            <div class="AreaM">
                ...
                <?php foreach($hotdata as $v){?>
                    <div class="goodsItem">
                        <a href="<?php echo U('Home/Index/detail',array('id'=>$v['id']))?>"><img src="<?php echo C('UPLOAD_ROOT_PATH').$v['goods_thumb'];?>" alt="诺基亚E66" class="goodsimg"></a><br />
                        <p class="f1"><a href="<?php echo U('Home/Index/detail',array('id'=>$v['id']))?>" title="诺基亚E66"><?php echo $v['goods_name']?></a></p>
                ...
                <div id="show_best_area" class="clearfix">
                    ...
                    <div class="goodsItem">
                        ...
                        <a href="#"><img src="/Public/home/images/1_thumb_G_1240902890710.jpg" alt="KD876" class="goodsimg"></a><br />
